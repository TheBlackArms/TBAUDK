...
namespace TheBlackArms
{
    ...
    public class TheBlackArms_ImportPanel_Shaders : EditorWindow
    {
       private const string Url = "https://github.com/TheBlackArms/TBAUDK/";
        ...
        {
            titleContent = new GUIContent("TheBlackArms Import panel shaders");
        ...
        public static void LoadJson()
        {
            ...
            dynamic configJson =
                JObject.Parse(File.ReadAllText(TheBlackArms_Settings.projectConfigPath + TheBlackArms_ImportManager_Shaders.configName));
