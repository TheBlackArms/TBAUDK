...
//using TheBlackArms_Shaders;
using TheBlackArms;
using UnityEditor;

namespace TheBlackArms
{
    public class TheBlackArms_ImportManager_EditorTools
    {
        private const string V = "https://c0dera.in/tbaudk/api/assets/editortools/";
        ...
        private static void configDownloadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            if (e.Error == null)
            {
                ...
                TheBlackArms_ImportPanel_EditorTools.LoadJson();
