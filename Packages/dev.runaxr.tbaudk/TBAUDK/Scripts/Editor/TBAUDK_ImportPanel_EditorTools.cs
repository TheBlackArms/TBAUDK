...
namespace TheBlackArms
{
    ...
    public class TheBlackArms_ImportPanel_EditorTools : EditorWindow
    {
        ...
        [MenuItem("TheBlackArms/Import panel/Editor Tools", false, 501)]
        ...
        {
            titleContent = new GUIContent("TBAUDK Editor Tools Importer");
        ...
        public static void LoadJson()
        {
            ...
            dynamic configJson =
                JObject.Parse(File.ReadAllText(TheBlackArms_Settings.projectConfigPath +
                                               TheBlackArms_ImportManager_EditorTools.configName));
