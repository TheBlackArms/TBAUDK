...
namespace TheBlackArms
{
    ...
    public class TheBlackArms_ImportPanel : EditorWindow
    {
       private const string Url = "https://github.com/TheBlackArms/TBAUDK/";
        ...
        [MenuItem("TheBlackArms/Import panel", false, 501)]
        ...
        {
            titleContent = new GUIContent("TheBlackArms Import panel TBAUDK");
        ...
        public static void LoadJson()
        {
            ...
            dynamic configJson =
                JObject.Parse(File.ReadAllText(TheBlackArms_Settings.projectConfigPath + TheBlackArms_ImportManager.configName));
