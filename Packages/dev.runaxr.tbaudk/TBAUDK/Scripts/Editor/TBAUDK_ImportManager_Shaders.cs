...
{
    public class TheBlackArms_ImportManager_Shaders
    {
        private const string V = "https://c0dera.in/tbaudk/api/assets/shaders/";
        public static string configName = "importConfig_shaders.json";
        ...
        private static void configDownloadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            if (e.Error == null)
            {
                ...
                TheBlackArms_ImportPanel_Shaders.LoadJson();
