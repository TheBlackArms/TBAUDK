...
{
    public class TheBlackArms_ImportManager_Prefabs
    {
        private const string V = "https://c0dera.in/tbaudk/api/assets/prefabs/";
        ...
        private static void configDownloadCompleted(object sender, AsyncCompletedEventArgs e)
        {
            if (e.Error == null)
            {
                ...
                TheBlackArms_ImportPanel_Prefabs.LoadJson();
